  ...
  return (
    <section className="bg-white py-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-primary-50 to-amber-50 rounded-lg p-8 sm:p-12">
          ...
          {/* Result card */}
          <div className="bg-white rounded-md p-8 shadow-lg mt-8">
            ...
            <div className="border-t border-gray-100 mt-4 pt-4 text-sm text-gray-600 space-y-1">
              <p>
                WachtlijstHelderheid kost &euro;{monthlyCost}/maand
              </p>
            ...
            <a
              href="#pricing"
              className="mt-6 inline-flex items-center gap-2 px-6 py-3 bg-primary-600 text-white font-medium rounded-md hover:bg-primary-700 transition-colors"
            >
              Start nu
              <ArrowRight size={18} />
            </a>
