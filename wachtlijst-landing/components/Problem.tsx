...
export default function Problem() {
  return (
    <section id="opvang" className="bg-navy-50 py-20">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-white rounded-xl p-6 shadow-sm border-l-4 border-primary-500"
          >
          ...
          <motion.div
            ...
            className="bg-white rounded-xl p-6 shadow-sm border-l-4 border-secondary-400"
          >
            ...
            <div className="flex items-center gap-3 mt-4">
              <div className="w-10 h-10 rounded-full bg-secondary-100 flex items-center justify-center text-secondary-700 font-semibold text-sm">
                S
              </div>
              <p className="text-sm text-navy-500">
